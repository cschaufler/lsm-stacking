...
static const struct attrs_map lsm_attr_names[] = {
	{ .name = "current",	.attr = LSM_ATTR_CURRENT, },
	{ .name = "exec",	.attr = LSM_ATTR_EXEC, },
	{ .name = "fscreate",	.attr = LSM_ATTR_FSCREATE, },
	{ .name = "keycreate",	.attr = LSM_ATTR_KEYCREATE, },
	{ .name = "prev",	.attr = LSM_ATTR_PREV, },
	{ .name = "sockcreate",	.attr = LSM_ATTR_SOCKCREATE, },
};
 ...
 */
SYSCALL_DEFINE2(lsm_set_self_attr,
		struct lsm_ctx __user *, ctx,
		u64, flags)
{
	return security_setselfattr(flags, ctx);
}
